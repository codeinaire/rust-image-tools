...
Count existing files in `plans/` for today's date and use the next number (zero-padded, starting at `01`). Example: if `20260307-01-foo.md` exists, use `02`.
...
File path: `plans/YYYYMMDD-NN-short-kebab-case-title.md`
